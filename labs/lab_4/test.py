...
class TestQr(unittest.TestCase):
    ...
    def test_roots(self):
        ...
        self.assertEqual(set(self.get_roots(10, -15, 0)), set([-6 ** 0.5 / 2, 0, 6 ** 0.5 / 2]))
        self.assertEqual(set(self.get_roots(0, 1, -16)), set([-4, 4]))
        self.assertEqual(set(self.get_roots(1, 0, -4)), set([-2 ** 0.5, 2 ** 0.5]))
        self.assertEqual(set(self.get_roots(1, -5, -36)), set([-3, 3]))
        self.assertEqual(set(self.get_roots(1, 14, 48)), set([]))
        self.assertEqual(set(self.get_roots(1, 1, -20)), set([-2, 2]))
        self.assertEqual(set(self.get_roots(1, -5, 4)), set([-2, -1, 1, 2]))
